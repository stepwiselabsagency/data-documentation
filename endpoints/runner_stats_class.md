# `/race-cards/runner-stats-class`

## Endpoint

```http id="o1n6ru"
GET /race-cards/runner-stats-class
```

## Description

Returns runner statistics based on the race class of the current race. Each item represents one horse/runner and includes the runner’s historical performance in the same race class.
...
| `race_class`           | `"6"`                           | Race class used for the runner statistics.                           |
...
| `runs`                 | `"0"`                           | Number of runner runs in this race class.                            |
| `wins`                 | `"0"`                           | Number of runner wins in this race class.                            |
| `Win %`                | `"0%"`                          | Runner win percentage in this race class.                            |
| `place`                | `"0"`                           | Number of runner places in this race class.                          |
| `Place %`              | `"0%"`                          | Runner place percentage in this race class.                          |
| `total_winnings`       | `"0"`                           | Total winnings for the runner in this race class.                    |
