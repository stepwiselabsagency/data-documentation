# `/race-cards/runner-stats-going`

## Endpoint

```http id="6uo7b1"
GET /race-cards/runner-stats-going
```

## Description

Returns runner statistics based on the going/ground condition of the current race. Each item represents one horse/runner and includes the runner’s historical performance on the same or similar going.
...
| `going_brief_advanced` | `"Good-good to firm in places"` | Detailed going/ground description used for the runner statistics.    |
...
| `runs`                 | `"0"`                           | Number of runner runs on this going/ground condition.                |
| `wins`                 | `"0"`                           | Number of runner wins on this going/ground condition.                |
| `Win %`                | `"0%"`                          | Runner win percentage on this going/ground condition.                |
| `place`                | `"0"`                           | Number of runner places on this going/ground condition.              |
| `Place %`              | `"0%"`                          | Runner place percentage on this going/ground condition.              |
| `total_winnings`       | `"0"`                           | Total winnings for the runner on this going/ground condition.        |
