# `/race-cards/runner-stats-distance`

## Endpoint

```http id="mso9f3"
GET /race-cards/runner-stats-distance
```

## Description

Returns runner statistics based on the race distance of the current race. Each item represents one horse/runner and includes the runner’s historical performance over the same distance/furlong range.
...
| `furlongs`             | `"6"`                           | Race distance/furlong group used for the runner statistics.          |
...
| `runs`                 | `"3"`                           | Number of runner runs over this race distance.                       |
| `wins`                 | `"0"`                           | Number of runner wins over this race distance.                       |
| `Win %`                | `"0%"`                          | Runner win percentage over this race distance.                       |
| `place`                | `"0"`                           | Number of runner places over this race distance.                     |
| `Place %`              | `"0%"`                          | Runner place percentage over this race distance.                     |
| `total_winnings`       | `"906"`                         | Total winnings for the runner over this race distance.               |
