# `/race-cards/jockey-stats-class`

## Endpoint

```http id="e2v91k"
GET /race-cards/jockey-stats-class
```

## Description

Returns jockey statistics for the race class of the current runner. Each item represents one runner and includes the jockey’s historical performance for the same race class.
...
| `race_class`       | `"6"`              | Race class used for the jockey statistics.                           |
...
| `runs`             | `"984"`            | Number of jockey runs in this race class.                            |
| `wins`             | `"109"`            | Number of jockey wins in this race class.                            |
| `Win %`            | `"11%"`            | Jockey win percentage in this race class.                            |
| `place`            | `"305"`            | Number of jockey places in this race class.                          |
| `Place %`          | `"31%"`            | Jockey place percentage in this race class.                          |
| `total_winnings`   | `"587385"`         | Total winnings for the jockey in this race class.                    |
